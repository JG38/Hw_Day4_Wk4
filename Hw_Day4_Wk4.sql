...
"outputs": [
    {
     ...
     "text": [
      "<Response [200] > \ n ",
      " < class 'requests.models.Response' > \ n ",
      " True \ n "
     ]
    }
   ],
...
"print(response)\n",
"print(type(response))\n",
"print(response.ok) #checks if its validated" ] },
{ "cell_type": "code",
"execution_count": 3,
"id": "c6d1fdaf",
"metadata": { },
...
'Constructors': [{'constructorId': 'ferrari', 'url': 'http://en.wikipedia.org/wiki/Scuderia_Ferrari', 'name': 'Ferrari', 'nationality': 'Italian'}] },
{ 'position': '3',
'positionText': '3',
'points': '75',
'wins': '2',
...
'nationality': 'Polish' },
'Constructors': [{'constructorId': 'bmw_sauber', 'url': 'http://en.wikipedia.org/wiki/BMW_Sauber', 'name': 'BMW Sauber', 'nationality': 'German'}] },
{ 'position': '5',
'positionText': '5',
'points': '61',
'wins': '2',
...
'nationality': 'Finnish' },
'Constructors': [{'constructorId': 'mclaren', 'url': 'http://en.wikipedia.org/wiki/McLaren', 'name': 'McLaren', 'nationality': 'British'}] },
{ 'position': '8',
'positionText': '8',
'points': '35',
'wins': '1',
...
'Constructors': [{'constructorId': 'red_bull', 'url': 'http://en.wikipedia.org/wiki/Red_Bull_Racing', 'name': 'Red Bull', 'nationality': 'Austrian'}] },
{ 'position': '12',
'positionText': '12',
'points': '19',
'wins': '0',
...
'nationality': 'German' },
'Constructors': [{'constructorId': 'williams', 'url': 'http://en.wikipedia.org/wiki/Williams_Grand_Prix_Engineering', 'name': 'Williams', 'nationality': 'British'}] },
{ 'position': '14',
'positionText': '14',
'points': '11',
'wins': '0',
...
'nationality': 'Brazilian' },
'Constructors': [{'constructorId': 'honda', 'url': 'http://en.wikipedia.org/wiki/Honda_Racing_F1', 'name': 'Honda', 'nationality': 'Japanese'}] },
{ 'position': '15',
'positionText': '15',
'points': '9',
'wins': '0',
...
'nationality': 'Italian' },
'Constructors': [{'constructorId': 'force_india', 'url': 'http://en.wikipedia.org/wiki/Racing_Point_Force_India', 'name': 'Force India', 'nationality': 'Indian'}] },
{ 'position': '20',
'positionText': '20',
'points': '0',
'wins': '0',
...
'nationality': 'British' },
'Constructors': [{'constructorId': 'super_aguri', 'url': 'http://en.wikipedia.org/wiki/Super_Aguri_F1', 'name': 'Super Aguri', 'nationality': 'Japanese'}] } ] } ] } } } \ n "
     ]
    }
   ],
   " source ": [
...
"source": [
    "# let's get the top 3 of whatever year and round we input\n",
    "def top_3(year, round):\n",
    "    response = requests.get(f'https://ergast.com/api/f1/{year}/{round}/driverStandings.json')\n",
    "    data = response.json()\n",
    "    for x in range(1,4):\n",
    "        f_name = data['MRData'] [\"StandingsTable\"] [\"StandingsLists\"] [0] [\"DriverStandings\"] [x] [\"Driver\"] ['givenName'] \ n ",
    " l_name = data ['MRData'] [\"StandingsTable\"] [\"StandingsLists\"] [0] [\"DriverStandings\"] [x] [\"Driver\"] ['familyName'] \ n ",
    " print(
    f \ "In position {x}, we have {f_name} {l_name}\")\n",
    "top_3(2023,22)\n",
    "    " ] },
    { "cell_type": "code",
    "execution_count": null,
    ...
    \ n ",
    " 'DEF_base': data ['stats'] [2] ['base_stat'] \ n ",
    " } \ n ",
    " return poke_dict \ n ",
    "
    except IndexError: \ n ",
    " return 'Please enter a valid poke name (or number)' \ n ",
    " \ n ",
